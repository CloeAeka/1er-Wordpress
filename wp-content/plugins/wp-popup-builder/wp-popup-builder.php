...
if((!is_plugin_active( 'themehunk-customizer/themehunk-customizer.php' )) && (!is_plugin_active( 'hunk-companion/hunk-companion.php' )) && (!is_plugin_active( 'lead-form-builder/lead-form-builder.php' ))){
