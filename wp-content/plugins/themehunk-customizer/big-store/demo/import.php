...
function big_store_import_files(){
  return apply_filters(
    ...
    array(
        ...
        'preview_url'=> esc_url('https://themehunk.com/wp-themes/big-store/'),
    ...
    array(
        ...
        'preview_url'=> esc_url('https://themehunk.com/wp-themes/bigstore-groceries/'),
        'import_notice' => __( 'Before importing the demo data, Install & Activate the recommended plugins.', 'big-store' ),
       ),
    array(
        ...
        'preview_url'=> esc_url('https://themehunk.com/wp-themes/big-store-electro/'),
        'import_notice' => __( 'Before importing the demo data, Install & Activate the recommended plugins.', 'big-store' ),
       ),
     )
  );
